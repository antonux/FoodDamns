...
const ApproveRequest = ({ onClose, recipeName }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-sm font-semibold mb-2 text-green-600">
          {`Preparing ${recipeName} recipe!`}
        </h2>
        <p className="text-sm text-gray-700">
          Please wait, we're gathering the recipe for you...
        </p>
